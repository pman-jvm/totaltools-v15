...
class PosSession(models.Model):
    ...
    def _credit_amounts(self, partial_move_line_vals, amount, amount_converted, force_company_currency=False):
        ...
        """
        # account_analytic_id = self.config_id.account_analytic_id and self.config_id.account_analytic_id.id or False
    ...
    def _get_sale_vals(self, key, amount, amount_converted):
        """
        This method is called when perform the action of close session.
        """
