    ...
    models.PosModel = models.PosModel.extend({
        ...
        /*load_server_data: function() {
            ...
            return loaded.then(function() {
                ...
                //         context: _.extend(self.product_product_model.context, {location: self.config.default_location_src_id[0], compute_child: false}),
                //         kwargs: {
                //             context: _.extend(self.product_product_model.context, {location: self.config.default_location_src_id[0], compute_child: false}),
                //         },
                //     })
                ...
                return rpc.query({
                    model: 'pos.config',
                    method: 'get_location_wise_stock',
                    args: [false,self.config_id],
                }).then(function (products) {
                    self.add_product_qty(products);
                });
            });
